/* ==================================================================================================
   ...
   Autores: Joaquin Viola, Sebastian Martony y Esteban Duran

   Descripcion:
   Archivo que define la estructura completa del Sistema de Gestion Academica,
   incluyendo la creacion de tablas, claves primarias y foraneas, checks y
   restricciones necesarias para garantizar la integridad del modelo relacional en MySQL.
================================================================================================== */
